var MESSAGES={"format.date":"MM/dd/yyyy","format.time":"h:mm a","photoviewer.toolbar.first":"В начало (Home)","photoviewer.toolbar.prev":"Предыдущее фото(Left arrow)","photoviewer.toolbar.slideShow":"Начать/Приостановить презинтацию (Space)","photoviewer.toolbar.next":"Следующее фото (Right arrow)","photoviewer.toolbar.last":"В конец (End)","photoviewer.toolbar.permalink":"Открыть фото в новой вкладке","photoviewer.toolbar.close":"Закрыть (Esc)","photoviewer.email.subject.photo":"Photo","gallery.nophotos":"No photos","gallery.thumbs.start":"Start","gallery.thumbs.end":"End","gallery.toolbar.first":"First Photo","gallery.toolbar.prev":"Previous Photo","gallery.toolbar.view":"View Photo","gallery.toolbar.next":"Next Photo","gallery.toolbar.last":"Last Photo","gallery.view.full":"Maximize Window","gallery.view.photo":"Show Photo Only","gallery.view.text":"Show Description Only","gallery.view.close":"Close Window"};var agent=navigator.userAgent.toLowerCase();var IE=(agent.indexOf("msie")!=-1&&agent.indexOf("opera")==-1);var IE7=(agent.indexOf("msie 7")!=-1);var IE8=(agent.indexOf("msie 8")!=-1);var OPERA=(agent.indexOf("opera")!=-1);var SAFARI=(agent.indexOf("safari")!=-1);var FIREFOX=(agent.indexOf("gecko")!=-1);var STRICT_MODE=(document.compatMode=="CSS1Compat");var GALLERY_W=650;var GALLERY_H=530;if(USE_GOOGLE_MAPS==undefined){var USE_GOOGLE_MAPS=true;}
